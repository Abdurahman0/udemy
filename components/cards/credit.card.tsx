		...
		<Card className='relative h-64 max-md:h-56'>
			<CardContent className='relative z-50 flex h-full flex-col justify-between py-4'>
				<div className='flex items-center justify-between'>
					...
					<h1 className='font-space_grotesk text-2xl font-bold capitalize italic'>
						{card.card.brand}
					</h1>
				</div>

				<div className='flex items-center justify-center gap-4 font-space_grotesk text-4xl max-md:text-2xl'>
					<div>****</div>
					<div>****</div>
					<div>****</div>
				...
				<div className='flex items-center justify-between'>
					<div className='flex flex-col'>
						...
						<p className='font-space_grotesk text-2xl font-bold capitalize max-md:text-xl'>
