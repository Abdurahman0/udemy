			...
			<div className='flex-1'>
				<div className='flex gap-3'>
					...
					<div className='flex flex-col'>
						<div className='font-space_grotesk text-sm'>
							Samar Badriddinov{' '}
						...
						<p className='text-sm text-muted-foreground'>
							...
							mollitia odit hic fugit unde qui vero perferendis labore iure
							similique dolorem dolorum vel ullam nobis voluptatum animi ad,
