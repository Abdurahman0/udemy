				...
				<div className='text-center'>
					...
					<div className='mt-4 grid w-full grid-cols-4 gap-4 rounded-lg border border-dashed border-primary p-8 max-md:grid-cols-1'>
						<div className='flex flex-col items-start'>
							<h2 className='font-space_grotesk font-bold'>{t('order')}</h2>
						...
						<div className='flex flex-col items-start'>
							<h2 className='font-space_grotesk font-bold'>{t('date')}</h2>
							<p className='text-sm font-bold text-primary'>
						...
						<div className='flex flex-col items-start'>
							<h2 className='font-space_grotesk font-bold'>{t('totals')}</h2>
							<p className='text-sm font-bold text-primary'>
