				...
				<div className='flex flex-col space-y-3'>
						...
						<CardContent className='py-4'>
							...
							{coupon > 0 && (
								<div className='mt-2 flex items-center justify-between rounded-md border border-green-500/30 bg-green-500/10 p-2'>
									<p className='font-space_grotesk text-sm font-bold text-green-500'>
							...
							{error && (
								<p className='mt-1 font-space_grotesk text-sm font-bold text-red-500'>
									{error}
								</p>
							)}
						</CardContent>
								...
								{carts.map(item => (
									...
									>
										<div className='flex items-center gap-2'>
											...
											<h1 className='font-space_grotesk font-bold'>
												{item.title}
											</h1>
										</div>
					...
					<Card className='bg-gradient-to-t from-secondary to-background'>
						<CardContent className='py-4'>
							...
							<div className='flex items-center justify-between text-sm'>
								<div className='font-space_grotesk font-bold'>{t('taxes')}</div>
								<div className='font-medium'>
							...
							<div className='flex items-center justify-between text-sm'>
								<div className='font-space_grotesk font-bold'>{t('total')}</div>
								<div className='font-medium'>
									{(taxes() + totalPrice(coupon)).toLocaleString('en-US', {
										style: 'currency',
										currency: 'USD',
									})}
								</div>
